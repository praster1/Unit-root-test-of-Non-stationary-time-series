...
for (ell in 1:100)
{
	...
	IDXGap_ADFTrend = rbind(IDXGap_ADFTrend, IDXGap_CI)
	...
	IDXGap_CI = NULL
	for (i in 1:10){	IDXGap_CI = c(IDXGap_CI, IDXGap(sampleVec_UnitRoot$index, analysisRes, changeIndex[i], critVal=2, testReverse=FALSE))}
	IDXGap_ADFDrift = rbind(IDXGap_ADFDrift, IDXGap_CI)
	...
	IDXGap_CI = NULL
	for (i in 1:10){	IDXGap_CI = c(IDXGap_CI, IDXGap(sampleVec_UnitRoot$index, analysisRes, changeIndex[i], critVal=2, testReverse=FALSE))}
	IDXGap_PPTrend = rbind(IDXGap_PPTrend, IDXGap_CI)
	...
	IDXGap_CI = NULL
	for (i in 1:10){	IDXGap_CI = c(IDXGap_CI, IDXGap(sampleVec_UnitRoot$index, analysisRes, changeIndex[i], critVal=2, testReverse=FALSE))}
	IDXGap_PPDrift = rbind(IDXGap_PPDrift, IDXGap_CI)
	...
	IDXGap_CI = NULL
	for (i in 1:10){	IDXGap_CI = c(IDXGap_CI, IDXGap(sampleVec_UnitRoot$index, analysisRes, changeIndex[i], critVal=2, testReverse=FALSE))}
	IDXGap_ERSDGTrend = rbind(IDXGap_ERSDGTrend, IDXGap_CI)
	...
	IDXGap_CI = NULL
	for (i in 1:10){	IDXGap_CI = c(IDXGap_CI, IDXGap(sampleVec_UnitRoot$index, analysisRes, changeIndex[i], critVal=2, testReverse=FALSE))}
	IDXGap_ERSDGConst = rbind(IDXGap_ERSDGConst, IDXGap_CI)
	...
	IDXGap_CI = NULL
	for (i in 1:10){	IDXGap_CI = c(IDXGap_CI, IDXGap(sampleVec_UnitRoot$index, analysisRes, changeIndex[i], critVal=2, testReverse=FALSE))}
	IDXGap_ERSPTrend = rbind(IDXGap_ERSPTrend, IDXGap_CI)
	...
	IDXGap_CI = NULL
	for (i in 1:10){	IDXGap_CI = c(IDXGap_CI, IDXGap(sampleVec_UnitRoot$index, analysisRes, changeIndex[i], critVal=2, testReverse=FALSE))}
	IDXGap_ERSPConst = rbind(IDXGap_ERSPConst, IDXGap_CI)
	...
	IDXGap_SPTau = rbind(IDXGap_SPTau, IDXGap_CI)
	...
	IDXGap_CI = NULL
	for (i in 1:10){	IDXGap_CI = c(IDXGap_CI, IDXGap(sampleVec_UnitRoot$index, analysisRes, changeIndex[i], testReverse=FALSE, ursp=TRUE))}
	IDXGap_SPRho = rbind(IDXGap_SPRho, IDXGap_CI)
	...
	IDXGap_CI = NULL
	for (i in 1:10){	IDXGap_CI = c(IDXGap_CI, IDXGap(sampleVec_UnitRoot$index, analysisRes, changeIndex[i], critVal=2, testReverse=FALSE))}
	IDXGap_KPSSTau = rbind(IDXGap_KPSSTau, IDXGap_CI)
	
	print(ell)
}


write.csv(IDXGap_ADFTrend, "03_IDXGap_ADFTrend.csv")
write.csv(IDXGap_ADFDrift, "03_IDXGap_ADFDrift.csv")
write.csv(IDXGap_PPTrend, "03_IDXGap_PPTrend.csv")
write.csv(IDXGap_PPDrift, "03_IDXGap_PPDrift.csv")
write.csv(IDXGap_ERSDGTrend, "03_IDXGap_ERSDGTrend.csv")
write.csv(IDXGap_ERSDGConst, "03_IDXGap_ERSDGConst.csv")
write.csv(IDXGap_ERSPTrend, "03_IDXGap_ERSPTrend.csv")
write.csv(IDXGap_ERSPConst, "03_IDXGap_ERSPConst.csv")
write.csv(IDXGap_SPTau, "03_IDXGap_SPTau.csv")
write.csv(IDXGap_SPRho, "03_IDXGap_SPRho.csv")
write.csv(IDXGap_KPSSTau, "03_IDXGap_KPSSTau.csv")