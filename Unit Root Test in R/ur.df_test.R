...
y = c(	-0.63879800,	0.06408028,		0.48604897,		-1.58697346,	0.30119843,
...
selectlags = "Fixed"		# selectlags = c("Fixed", "AIC", "BIC")
    ...
    if (type == "none") 
	{
        cval.tau1 = rbind(	c(-2.66, -1.95, -1.6),
							c(-2.62, -1.95, -1.61),
							c(-2.6, -1.95, -1.61),
							c(-2.58, -1.95, -1.62), 
							c(-2.58, -1.95, -1.62),
    ...
    if (type == "drift") 
	{
        cval.tau2 = rbind(	c(-3.75, -3, -2.63),
							c(-3.58, -2.93, -2.6),
							c(-3.51, -2.89, -2.58),
							c(-3.46, -2.88, -2.57), 
							c(-3.44, -2.87, -2.57),
							c(-3.43, -2.86, -2.57))
        cval.phi1 = rbind(	c(7.88, 5.18, 4.12),
							c(7.06, 4.86, 3.94),
							c(6.7, 4.71, 3.86),
							c(6.52, 4.63, 3.81),
							c(6.47, 4.61, 3.79),
    ...
    if (type == "trend") 
	{
        cval.tau3 = rbind(	c(-4.38, -3.6, -3.24),
							c(-4.15, -3.5, -3.18),
							c(-4.04, -3.45, -3.15),
							c(-3.99, -3.43, -3.13), 
							c(-3.98, -3.42, -3.13),
							c(-3.96, -3.41, -3.12))
        cval.phi2 = rbind(	c(8.21, 5.68, 4.67),
							c(7.02, 5.13, 4.31),
							c(6.5, 4.88, 4.16), 
							c(6.22, 4.75, 4.07),
							c(6.15, 4.71, 4.05),
							c(6.09, 4.68, 4.03))
        cval.phi3 = rbind(	c(10.61, 7.24, 5.91),
							c(9.31, 6.73, 5.61),
							c(8.73, 6.49, 5.47),
							c(8.43, 6.49, 5.47), 
							c(8.34, 6.3, 5.36),
